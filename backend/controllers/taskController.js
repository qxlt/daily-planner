...
export const getTaskById = async (req, res) => {
    ...
    const { data, error } = await getOneTaskById(id);
...
export const getTaskByDate = async (req, res) => {
    ...
    const { data, error } = await getTasksByDate(date);
...
export const updateTask = async (req, res) => {
    ...
    const { data, error } = await updateOneTask(id, updates);
...
export const deleteTask = async (req, res) => {
    ...
    const { data, error } = await deleteOneTask(id);
